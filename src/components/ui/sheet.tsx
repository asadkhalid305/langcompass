...
const sheetVariants = cva(
  "fixed z-50 bg-background shadow-xl transition-transform duration-200 ease-out motion-reduce:transition-none data-[state=closed]:duration-150",
  {
    variants: {
      side: {
