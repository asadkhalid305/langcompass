...
interface LevelNavigationProps {
  selectedLevel: TopicLevelOrAll
  levelCounts: Record<TopicLevelOrAll, LevelCountsSummary>
...
interface OverviewViewProps {
  ...
  selectedLevelCounts: LevelCountsSummary
...
const LEVEL_PROFILES: Record<TopicLevelOrAll, LevelProfile> = {
  [ALL_LEVEL]: {
...
export function LangCompassShell({ mode, topics, detailTopicIds, initialRouteState }: LangCompassShellProps) {
  ...
  const levelCounts = useMemo<Record<TopicLevelOrAll, LevelCountsSummary>>(
    () => ({
      [ALL_LEVEL]: {
          ...
          <div className="flex items-center justify-between py-3 md:py-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <select
                ...
                value={selectedLevel}
                onChange={(event) => handleLevelSelect(event.target.value as TopicLevelOrAll)}
